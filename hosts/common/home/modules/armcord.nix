...
# Note: This is just nixpkgs/armcord but using 3.2.4-e27 instead of 3.2.4
# to fix https://github.com/ArmCord/ArmCord/issues/454
    ...
    in
      {
        x86_64-linux = fetchurl {
          url = "${base}/v${version}-e27/ArmCord_${version}_amd64.deb";
          hash = "sha256-MOzd82yMVgG5tOIoFom7dCzeaMZXCfmSmQg3TUjuh6k=";
        };
        aarch64-linux = fetchurl {
          url = "${base}/v${version}-e27/ArmCord_${version}_arm64.deb";
          hash = "sha256-MOzd82yMVgG5tOIoFom7dCzeaMZXCfmSmQg3TUjuh6k=";
        };
